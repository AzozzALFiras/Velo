...
/// The main workspace view with 3-panel layout using NavigationSplitView
struct WorkspaceRoot: View {
            ...
            NavigationSplitView(columnVisibility: $columnVisibility) {
                ...
                WorkspaceSidebar(
                    ...
                    onSelectSession: { id in 
                        ...
                        tabManager.switchToSession(id: id) 
                    },
    ...
    private var toolbarItems: some View {
        ...
        .help(showIntelligencePanel ? "intelligence.hide".localized : "intelligence.show".localized)
    }
    ...
    private func editFile(at path: String) {
        ...
        do {
            ...
            if data.count > 1024 * 1024 * 2 { // > 2MB
                ...
                alertMessage = "This file is too large to open in the workspace editor. Opening with system default instead."
                showAlert = true
                NSWorkspace.shared.open(url)
                return
            }
    ...
    private func saveFile(at path: String, content: String) {
        ...
        do {
            ...
            editingFileContent = content
            tabManager.activeSession?.showSuccessToast("Saved successfully")
        } catch {
            tabManager.activeSession?.showErrorToast("Save failed: \(error.localizedDescription)")
        }
    }
