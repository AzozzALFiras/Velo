//
//  RedisDetailViewModel.swift
//  Velo
//
//  ViewModel for detailed Redis management.
//
...
@MainActor
final class RedisDetailViewModel: ObservableObject {
    ...
    @Published var configPath: String = "/etc/redis/redis.conf"
