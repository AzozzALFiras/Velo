...
struct NginxDetailView: View {
    ...
    var body: some View {
        HStack(spacing: 0) {
            // Sidebar
            NginxSidebarView(viewModel: viewModel, onDismiss: onDismiss)
            ...
            ScrollView {
                ZStack {
                    Group {
                        ...
                        case .modules:
                             NginxModulesView(viewModel: viewModel)
                        case .security:
                    ...
                    // Show installation status overlay
                        ...
                        VStack(alignment: .leading) {
                            ...
                            HStack(spacing: 8) {
                                ...
                                VStack(alignment: .leading, spacing: 2) {
                                    Text("Installing Nginx \(viewModel.installingVersionName)...")
                                        .font(.caption)
                                        .fontWeight(.medium)
