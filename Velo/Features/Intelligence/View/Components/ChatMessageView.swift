    ...
    var body: some View {
        VStack(alignment: message.isUser ? .trailing : .leading, spacing: 6) {
            ...
            HStack(spacing: 4) {
                ...
                Text(message.isUser ? "intelligence.chat.you".localized : "intelligence.chat.velo".localized)
        ...
        VStack(alignment: .leading, spacing: 6) {
            ...
            HStack(spacing: 8) {
                Button {
                    ...
                    Label("intelligence.chat.run".localized, systemImage: "play.fill")
                        .font(.system(size: 10, weight: .medium))
                }
                .buttonStyle(.plain)
                ...
                Button {
                    ...
                    Label(isCopied ? "intelligence.chat.copied".localized : "intelligence.chat.copy".localized, systemImage: isCopied ? "checkmark" : "doc.on.doc")
                        .font(.system(size: 10, weight: .medium))
                }
                .buttonStyle(.plain)
