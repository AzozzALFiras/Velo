...
enum IntelligenceTab: String, CaseIterable, Identifiable {
    ...
    var label: String {
        switch self {
        case .chat: return "intelligence.tab.chat".localized
        case .history: return "intelligence.tab.history".localized
        case .files: return "intelligence.tab.files".localized
        case .errors: return "intelligence.tab.errors".localized
        case .suggestions: return "intelligence.tab.suggestions".localized
        case .scripts: return "intelligence.tab.scripts".localized
        }
    }
