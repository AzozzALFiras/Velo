...
//  Velo
//
//  Workspace Redesign - Complete Command Block View
...
struct BlocksEmptyState: View {
    ...
    var body: some View {
        VStack(spacing: 24) {
            ...
            VStack(spacing: 8) {
                Text("terminal.empty.title".localized)
                    .font(.system(size: 18, weight: .semibold))
                    .foregroundStyle(ColorTokens.textPrimary)
                    .fixedSize(horizontal: true, vertical: false)
                
                Text("terminal.empty.subtitle".localized)
                    .font(.system(size: 13))
            ...
            HStack(spacing: 20) {
                keyboardHint(key: "⌘N", label: "terminal.empty.newTab".localized)
                keyboardHint(key: "⌘K", label: "terminal.empty.clear".localized)
                keyboardHint(key: "↑", label: "terminal.empty.history".localized)
            }
            .fixedSize()
            .padding(.top, 8)
        }
