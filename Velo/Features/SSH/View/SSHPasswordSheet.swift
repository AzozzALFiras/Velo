    ...
    var body: some View {
        VStack(spacing: 24) {
            ...
            VStack(spacing: 8) {
                ...
                Text("ssh.password.title".localized)
                    .font(.system(size: 18, weight: .bold))
                    .foregroundStyle(ColorTokens.textPrimary)
                
                Text("ssh.password.hint".localized.replacingOccurrences(of: "{}", with: serverName))
                    .font(.system(size: 13))
            ...
            VStack(alignment: .leading, spacing: 8) {
                Text("ssh.password.label".localized)
            ...
            HStack(spacing: 6) {
                Image(systemName: "lock.shield.fill")
                    .font(.system(size: 11))
                Text("ssh.password.keychain".localized)
                    .font(.system(size: 11))
            }
